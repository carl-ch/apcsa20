 ...
 */
public class MusicianCelebrity extends Celebrity
{
	/**
	 ...
	 */
	public MusicianCelebrity(String answer, String clues)
	{
		super(answer, clues);
		processClues();
	}
	...
	{
		String dsc = "This is the musician celebrity: " + getAnswer() + "\nThe clues are:\n";
